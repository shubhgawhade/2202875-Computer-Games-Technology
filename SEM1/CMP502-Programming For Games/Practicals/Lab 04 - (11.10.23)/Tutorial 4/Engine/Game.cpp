...
//	context->RSSetState(m_states->Wireframe());
    ...
    //for (int i = 0; i < 12; i++)
    {
        ...
        SimpleMath::Matrix rotateInAxis = SimpleMath::Matrix::CreateRotationY(XMConvertToRadians(rot));
        SimpleMath::Matrix newRotation3 = SimpleMath::Matrix::CreateRotationY(XMConvertToRadians(rot));
        SimpleMath::Matrix rotateAround = SimpleMath::Matrix::CreateTranslation(2.0f, 1.0f, 0.0f);
        m_world = m_world * newscale3 * rotateInAxis * radiusOfRot * newRotation3 * rotateAround;
