...
bool rotateCameraRight, rotateCameraUp, rotateCameraLeft, rotateCameraDown;
float xAxis = 0.0f;
float yAxis = 0.0f;
...
#pragma region STAR CENTERED
    ...
    iArrayStarTop[1] = 1;
    iArrayStarTop[2] = 2;
    vArrayStarTop[0] = VertexPositionColor(Vector3(2.f, 0.5f, 0.5f), Colors::Yellow);
    vArrayStarTop[1] = VertexPositionColor(Vector3(1.5f, -0.5f, 0.5f), Colors::Yellow);
    vArrayStarTop[2] = VertexPositionColor(Vector3(2.5f, -0.5f, 0.5f), Colors::Yellow);
    ...
    vArrayStarBottom[0] = VertexPositionColor(Vector3(2.f, -0.75f, 0.5f), Colors::Yellow);
    vArrayStarBottom[1] = VertexPositionColor(Vector3(2.5f, 0.25f, 0.5f), Colors::Yellow);
    vArrayStarBottom[2] = VertexPositionColor(Vector3(1.5f, 0.25f, 0.5f), Colors::Yellow);
...
#pragma region CIRCLE
    ...
    {
        vArrayCircle[i++] = VertexPositionColor(Vector3(0.f, 0.f, 0.5f), Colors::DarkOrange);
    ...
    float radius1 = 0.3;
    int sides1 = 12;
    float angle1 = XMConvertToRadians(360 / sides1);
    
    const int vCountCircle1 = 3 * sides1;
    const int iCountCircle1 = 3 * sides1;
    uint16_t* iArrayCircle1;
    VertexPositionColor* vArrayCircle1;
    iArrayCircle1 = new uint16_t[iCountCircle1];
    vArrayCircle1 = new VertexPositionColor[vCountCircle1];
    
    for (int i = 0; i < iCountCircle1; i++)
    {
        iArrayCircle1[i] = i;
    }
    
    for (int i = 0; i < vCountCircle1;)
    {
        vArrayCircle1[i++] = VertexPositionColor(Vector3(0.f, 0.f, 0.5f), Colors::Black);
        vArrayCircle1[i++] = VertexPositionColor(Vector3(radius1 * cos(angle1), radius1 * sin(angle1), 0.5f), Colors::DarkCyan);
        angle1 += XMConvertToRadians(360 / sides1);
        vArrayCircle1[i++] = VertexPositionColor(Vector3(radius1 * cos(angle1), radius1 * sin(angle1), 0.5f), Colors::DarkCyan);
    }
    
    m_batch->DrawIndexed(D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST, iArrayCircle1, iCountCircle1, vArrayCircle1, vCountCircle1);
