...
bool Terrain::InitializeBuffers(ID3D11Device* device)
{
    ...
    for (j = 0; j < (m_terrainHeight - 1); j++)
    {
        for (i = 0; i < (m_terrainWidth - 1); i++)
        {
            ...
            // Upper left.
            vertices[index].position = DirectX::SimpleMath::Vector3(m_heightMap[index3].x, m_heightMap[index3].y,
                                                                    m_heightMap[index3].z);
            vertices[index].normal = DirectX::SimpleMath::Vector3(m_heightMap[index3].nx, m_heightMap[index3].ny,
            ...
            // Upper right.
            vertices[index].position = DirectX::SimpleMath::Vector3(m_heightMap[index4].x, m_heightMap[index4].y,
                                                                    m_heightMap[index4].z);
            vertices[index].normal = DirectX::SimpleMath::Vector3(m_heightMap[index4].nx, m_heightMap[index4].ny,
            ...
            // Bottom left.
            vertices[index].position = DirectX::SimpleMath::Vector3(m_heightMap[index1].x, m_heightMap[index1].y,
                                                                    m_heightMap[index1].z);
            vertices[index].normal = DirectX::SimpleMath::Vector3(m_heightMap[index1].nx, m_heightMap[index1].ny,
            ...
            // Bottom right.
            vertices[index].position = DirectX::SimpleMath::Vector3(m_heightMap[index2].x, m_heightMap[index2].y,
                                                                    m_heightMap[index2].z);
            vertices[index].normal = DirectX::SimpleMath::Vector3(m_heightMap[index2].nx, m_heightMap[index2].ny,
...
void Terrain::ClassicPerlinNoise()
{
    ...
    for (int j = 0; j < m_terrainHeight; j++)
    {
        for (int i = 0; i < m_terrainWidth; i++)
        {
            ...
            for (int k = 0; k < 8; k++)
            {
                res += classicPerlinNoise.Noise(i * m_scale + m_offset,
                                                j * m_scale + m_offset, m_seed) * amplitude;
            ...
            // res = classicPerlinNoise.Noise(i * m_scale + m_offset,
            // 							j * m_scale + m_offset, m_seed);

            m_heightMap[index].x = (float)i;
            m_heightMap[index].y = res * m_maxHeight;
            m_heightMap[index].z = (float)j;
        }
    }
}

void Terrain::SimplexNoise()
{
    int index;
    ...
    for (int j = 0; j < m_terrainHeight; j++)
    {
        for (int i = 0; i < m_terrainWidth; i++)
        {
            ...
            for (int k = 0; k < 8; k++)
            {
                res += simplexNoise.Noise3D(i * m_scale + m_offset,
                                            j * m_scale + m_offset, m_seed) * amplitude;
...
void Terrain::Faulting()
{
    ...
    for (int j = 0; j < m_terrainHeight; j++)
    {
        for (int i = 0; i < m_terrainWidth; i++)
        {
            ...
            SimpleMath::Vector2 dir1 = SimpleMath::Vector2(5, 5) - SimpleMath::Vector2(
                m_heightMap[index].x, m_heightMap[index].z);
            dir1.Normalize();
...
int* Terrain::GetSetSeed(int seed)
{
    if (seed == NULL)
    {
        return &m_seed;
